...
* If a library coordinate is a Gradle plugin descriptor, it will not be filtered out anymore ([#195](https://github.com/littlerobots/version-catalog-update-plugin/issues/195))
