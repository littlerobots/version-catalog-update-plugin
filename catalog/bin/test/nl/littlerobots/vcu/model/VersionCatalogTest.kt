...
class VersionCatalogTest {
    ...
    fun `updateCatalog adds library`() {
        ...
        val updatedCatalog =
            VersionCatalog(
                emptyMap(),
                mapOf(
                    "generated-library-reference" to
                        Library(
        ...
        val updatedCatalog =
            VersionCatalog(
                ...
                mapOf(
                    ...
                    "generated-library-reference-2" to
                        Library(
        ...
        val updatedCatalog =
            VersionCatalog(
                ...
                mapOf(
                    ...
                    "generated-library-reference2" to
                        Library(
                            module = "androidx.camera:camera-core",
                            version = VersionDefinition.Simple("1.3.1"),
                        ),
                    "generated-library-reference3" to
                        Library(
    ...
    fun `Room dependency update keeps correct version reference`() {
        ...
        assertEquals(
            Library("androidx.room:room-paging", version = VersionDefinition.Reference("roomPaging")),
            result.libraries["roomPaging"],
        )
